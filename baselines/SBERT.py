...
class SentenceBert(nn.Module):
    ...
    def get_feature(self, example):
        ...
        # print(features.size(), pooled_output_des.size())
        # expand_pooled_output_des = pooled_output_des.repeat(features.size(0), 1)
        # features = torch.cat([pooled_output, expand_pooled_output_des, torch.abs(pooled_output - expand_pooled_output_des)], dim=1)
