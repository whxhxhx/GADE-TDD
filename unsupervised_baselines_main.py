...
import json
import numpy as np
# from tf_idf import Tf_Idf_Ranker
...
def validate(model, dataset, thredhold_list):
    ...
    for e, des in ent_des.items():
        ...
        m = e2m[e]
        # sim_score = model.run(des, doc_list)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--entity_path', type=str, default='datasets/wiki300/id2entity.txt')
    parser.add_argument('--data_path', type=str, default='datasets/wiki300/mention_document.json')
    ...
    for i in range(kfold):
        ...
        # test_f1 = test(test_dataset, thredhold)
